...
import { LayoutGrid,Menu, ChevronDown,GraduationCap } from "lucide-react";
import { categories } from "../data/categories";
import { subCategories } from "../data/subCategories";

export default function CategoryGraduation() {
      ...
      ">
        ...
        <div className="flex">
          ...
          <div className="w-1/4 p-2">
            <h4 className="font-bold text-sm mb-3 text-gray-700 border-r border-[#CB2D58] border-r-4 pr-2">
